...
[autoEncoder_mappedX, autoEncoder_mapping] = compute_mapping(faceImgArray, 'AutoEncoder', reducedDim);
recX_AutoEncoder = reconstruct_data(autoEncoder_mappedX, autoEncoder_mapping);%recX = imN * imFeature
recX_PCA = reconstruct_data(recX_AutoEncoder, pca_mapping);
